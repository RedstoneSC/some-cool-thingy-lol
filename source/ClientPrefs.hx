...
class ClientPrefs {
	...
	public static var movingCamera:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.movingCamera = movingCamera;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.movingCamera != null) {
			movingCamera = FlxG.save.data.movingCamera;
		}
